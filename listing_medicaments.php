    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class= search-bar>
                <form action="medicaments.php" method="GET"
        ...
        <!-- End of Sidebar -->
                    ...
                    <?php
                       ...
                       $sql = "SELECT id,nom,description,prix,stock,reference,created_at FROM  medicament ";
                             ...
                             <tbody>
                                  ...
                                  <?php   while($row = mysqli_fetch_array($retval)) {  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="./edit_medicaments.php?id_medicaments=<?= $row["id"] ?>"><button type="button" class="btn btn-primary">Modifier</button> </a> 

                                        <a href="./delete_medicaments.php?id_medicaments=<?= $row["id"] ?>"><button type="button" class="btn btn-primary">Supprimer</button> </a>   </td>
