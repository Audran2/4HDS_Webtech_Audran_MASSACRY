    ...
    <div id="wrapper">
        ...
        <!-- End of Sidebar -->
                ...
                <form
                    ...
                    <a href="./medicament-user.php"><button type="button" class="btn btn-primary">Medicament par utilisateur</button> </a>    

                    <?php

                       $sql = "SELECT nom_medicament, GROUP_CONCAT(nom_user) FROM users_medicaments GROUP BY nom_medicament";
                          ...
                          <table class="table">
                             ...
                             <tbody>
                                  ...
                                  <?php   while($row = mysqli_fetch_array($retval)) {  ?>
                                    ...
                                    <tr>
                                        <th scope="row"><?= $row["nom_medicament"]  ?> </th>
                                        <td><?= $row["GROUP_CONCAT(nom_user)"]  ?></td>
                                    </tr>
