    ...
    <div id="wrapper">
        ...
        <!-- End of Sidebar -->
                ...
                <form
                    ...
                    <a href="./user-medicament.php"><button type="button" class="btn btn-primary">Utilisateur par medicament</button> </a>    

                    <?php

                       $sql = "SELECT nom_user, GROUP_CONCAT(nom_medicament) FROM users_medicaments GROUP BY nom_user";
                          ...
                          <table class="table">
                             ...
                             <tbody>
                                  ...
                                  <?php   while($row = mysqli_fetch_array($retval)) {  ?>
                                    ...
                                    <tr>
                                        <th scope="row"><?= $row["nom_user"]  ?> </th>
                                        <td><?= $row["GROUP_CONCAT(nom_medicament)"]  ?></td>
                                    </tr>
